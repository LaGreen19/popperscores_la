 ...
 */
function pooperscores_la_posted_on() {
 ...
 */
function pooperscores_la_entry_footer() {
	// Hide category and tag text for pages.
	if ( 'post' === get_post_type() ) {
		/* translators: used between list items, there is a space after the comma */
		$categories_list = get_the_category_list( esc_html__( ', ', 'pooperscores_la' ) );
	...
	edit_post_link(
		sprintf(
			...
			esc_html__( 'Edit %s', 'pooperscores_la' ),
 ...
 * @return bool
 */
function pooperscores_la_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'pooperscores_la_categories' ) ) ) {
	...
	if ( $all_the_cool_cats > 1 ) {
		...
		// This blog has only 1 category so pooperscores_la_categorized_blog should return false.
		return false;
	}
}
/**
 ...
 */
function pooperscores_la_category_transient_flusher() {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) {
		return;
	}
	// Like, beat it. Dig?
	delete_transient( 'pooperscores_la_categories' );
}
